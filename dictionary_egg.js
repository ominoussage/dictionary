...
function fetchData() {
    ...
    else if (keywordValue == "a word"){
        document.getElementById('sentence').style.color = 'white';
        contentDetails.innerHTML = "<span><b>OMG! You did exactly what I told you to do! Here, have a kitty as a gift.</b></span><img src=\"https://welovecatsandkittens.com/wp-content/uploads/2016/02/likes-cutie-copy.jpg\" height=\"200\">";
        document.getElementById('body').style.backgroundImage = 'linear-gradient(90deg, red, orange, yellow, green, blue, purple)'
        document.getElementById('html').style.backgroundImage = 'linear-gradient(90deg, red, orange, yellow, green, blue, purple)';
        document.getElementById('body').style.animation = 'animate 1s ease infinite';
        document.getElementById('html').style.animation = 'animate 1s ease infinite';
    } else {
